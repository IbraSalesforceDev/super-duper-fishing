    ...
    <main className="max-w-6xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="grid lg:grid-cols-[1fr_1.2fr] gap-6 items-start">
        <section className="space-y-3">
          <div className="h-[360px] sm:h-[420px] rounded-xl overflow-hidden border border-sea-700/60">
            <MapPicker
              stations={STATIONS}
          ...
          <p className="text-xs text-sea-400">
            Pincha en el mapa para usar la estación de marea oficial más cercana.
          </p>
        </section>
        ...
        <section className="space-y-3 min-h-[300px]">
          {bestDay && (
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3">
              ...
              <p className="text-sm mt-0.5">
                ...
                {bestDay.windows[0] && (
                  <>· mejor franja al rededor de las{" "}
                    {new Intl.DateTimeFormat("es-ES", {
                      hour: "2-digit",
                      minute: "2-digit",
          ...
          {loading && <p className="text-sea-300">Calculando previsión…</p>}
          {error && (
